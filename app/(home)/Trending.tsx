  ...
  return (
    <section className="pt-3 pb-10">
      <div className="flex items-center gap-3">
        ...
        <p className="text-sm">
          Future is accesible to us Now and Here, be aware of the benefits that
          you are eligible getting with us.
        </p>
      </div>
      ...
      <p className="text-sm">
        The latest updates of futuristic events, and abilities that AI could get
        us is amazing. You can make your life easier with all of this abilities.
      </p>
    </section>
  );
};
